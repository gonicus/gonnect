...
from conan.tools.files import apply_conandata_patches, export_conandata_patches, chdir, copy, get, rm, rmdir, replace_in_file
...
class OpenldapConan(ConanFile):
    ...
    def package_info(self):
        self.cpp_info.components["ldap"].set_property("cmake_target_name", "OpenLDAP::LDAP")
        ...
        self.cpp_info.components["lber"].set_property("cmake_target_name", "OpenLDAP::LBER")
