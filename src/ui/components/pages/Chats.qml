...
Item {
    ...
    Card {
        ...
        MatrixMessageList {
            ...
            chatRoom: control.attachedData?.chatRoom()?.chatRoomById(matrixRoomList.selectedRoomId) ?? null
            clip: true
            anchors {
                left: parent.left
                right: parent.right
        ...
        MatrixMessageBox {
            ...
            onSendMessage: () => {
                control.attachedData.chatRoom.sendMessage(matrixRoomList.selectedRoomId, matrixMessageBox.text)
